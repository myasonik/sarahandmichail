...
function submitHandler() {
  const rsvpDialogContainer = document.getElementById('rsvp-dialog');
  const rsvpDialog = new A11yDialog(rsvpDialogContainer);
...
function getPendingRsvps() {
  ...
  // TODO: Figure out how to display error if family_name ("This RSVP is for:") is not included in the mapping.
